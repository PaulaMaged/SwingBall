...
namespace CrazyMinnow.SALSA.OneClicks
{
	public class OneClickAutodeskCG : OneClickBase
	{
		/// <summary>
		/// RELEASE NOTES:
		///		2.7.2 : Updated for OneClickBase 2.7.2.
		///		2.5.0 : Updated for SALSA and EmoteR v2.5.0.
		...
		/// ==========================================================================
		/// </summary>
		// public static void Setup(GameObject gameObject, AudioClip clip, int lodLevel = -1)
		public static void Setup(GameObject gameObject, List<SkinnedMeshRenderer> smrs)
		{
			////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//	SETUP Requirements:
			...
			string bodySearch = smrs[0].name;
			string teethSearch = smrs[1].name;
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
			{
				...
				NewExpression("w");
				AddShapeComponent(new[] {"c_teeth.t_UW_U_c", "l_teeth.t_UW_U_l", "m_teeth.t_UW_U_m", "h_teeth.t_UW_U_h"}, 0.11f, 0f, 0.06f, "t_UW_U", 1f);
				AddShapeComponent(new[] {"c_expressions.UW_U_c", "l_expressions.UW_U_l", "m_expressions.UW_U_m", "h_expressions.UW_U_h"}, 0.11f, 0f, 0.06f, "UW_U", 1f);

				NewExpression("t");
				AddShapeComponent(new[] {"c_teeth.t_TD_I_c", "l_teeth.t_TD_I_l", "m_teeth.t_TD_I_m", "h_teeth.t_TD_I_h"}, 0.11f, 0f, 0.06f, "t_TD_I", 1f);
				AddShapeComponent(new[] {"c_expressions.TD_I_c", "l_expressions.TD_I_l", "m_expressions.TD_I_m", "h_expressions.TD_I_h"}, 0.11f, 0f, 0.06f, "TD_I", 1f);
				AddShapeComponent(new[] {"c_expressions.UW_U_c", "l_expressions.UW_U_l", "m_expressions.UW_U_m", "h_expressions.UW_U_h"}, 0.11f, 0f, 0.06f, "UW_U", 0.602f);

				NewExpression("f");
				AddShapeComponent(new[] {"c_teeth.t_FV_c","l_teeth.t_FV_l","m_teeth.t_FV_m","h_teeth.t_FV_h"}, 0.11f, 0f, 0.06f, "t_FV", 1f);
				AddShapeComponent(new[] {"c_expressions.FV_c","l_expressions.FV_l","m_expressions.FV_m","h_expressions.FV_h"}, 0.11f, 0f, 0.06f, "FV", 1f);

				NewExpression("th");
				AddShapeComponent(new[] {"c_teeth.t_KG_c","l_teeth.t_KG_l","m_teeth.t_KG_m","h_teeth.t_KG_h"}, 0.11f, 0f, 0.06f, "t_KG", 1f);
				AddShapeComponent(new[] {"c_expressions.TD_I_c", "l_expressions.TD_I_l", "m_expressions.TD_I_m", "h_expressions.TD_I_h"}, 0.11f, 0f, 0.06f, "TD_I", 1f);
				AddShapeComponent(new[] {"c_expressions.UW_U_c", "l_expressions.UW_U_l", "m_expressions.UW_U_m", "h_expressions.UW_U_h"}, 0.11f, 0f, 0.06f, "UW_U", 0.721f);

				NewExpression("ow");
				AddShapeComponent(new[] {"c_teeth.t_AO_a_c","l_teeth.t_AO_a_l","m_teeth.t_AO_a_m","h_teeth.t_AO_a_h"}, 0.11f, 0f, 0.06f, "t_AO_a", 0.735f);
				AddShapeComponent(new[] {"c_expressions.AO_a_c","l_expressions.AO_a_l","m_expressions.AO_a_m","h_expressions.AO_a_h"}, 0.11f, 0f, 0.06f, "AO_a", 0.246f);
				AddShapeComponent(new[] {"c_expressions.UH_OO_c","l_expressions.UH_OO_l","m_expressions.UH_OO_m","h_expressions.UH_OO_h"}, 0.11f, 0f, 0.06f, "UH_OO", 0.986f);

				NewExpression("ee");
				AddShapeComponent(new[] {"c_teeth.t_H_EST_c","l_teeth.t_H_EST_l","m_teeth.t_H_EST_m","h_teeth.t_H_EST_h"}, 0.11f, 0f, 0.06f, "t_H_EST", 0.588f);
				AddShapeComponent(new[] {"c_expressions.S_c","l_expressions.S_l","m_expressions.S_m","h_expressions.S_h"}, 0.11f, 0f, 0.06f, "S", 0.665f);
				AddShapeComponent(new[] {"c_expressions.H_EST_c","l_expressions.H_EST_l","m_expressions.H_EST_m","h_expressions.H_EST_h"}, 0.11f, 0f, 0.06f, "H_EST", 0.804f);

				NewExpression("oo");
				AddShapeComponent(new[] {"c_teeth.t_AO_a_c","l_teeth.t_AO_a_l","m_teeth.t_AO_a_m","h_teeth.t_AO_a_h"}, 0.11f, 0f, 0.06f, "t_AO_a", 1f);
				AddShapeComponent(new[] {"c_expressions.AO_a_c","l_expressions.AO_a_l","m_expressions.AO_a_m","h_expressions.AO_a_h"}, 0.11f, 0f, 0.06f, "AO_a", 1f);
			}
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Emoter);
			{
				...
				AddEmoteFlags(false, true, false, 0.4f);
